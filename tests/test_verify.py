...
def test_verify_clean(clean_receipt):
    signed = sign_receipt(clean_receipt)
    result = verify_receipt(signed)
    assert result["valid"] is True

def test_verify_tampered_decision(clean_receipt):
    signed = sign_receipt(clean_receipt)
...
def test_verify_tampered_action(clean_receipt):
    signed = sign_receipt(clean_receipt)
...
def test_verify_tampered_evidence(clean_receipt):
    signed = sign_receipt(clean_receipt)
