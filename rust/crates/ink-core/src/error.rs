...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let message = match self {
            ...
            Self::UnsupportedSignatureProfile => "unsupported signature profile",
            ...
            Self::MissingSealedHash => "missing sealed hash",
            Self::UnexpectedSealedHash => "unexpected sealed hash",
            Self::InvalidAttestationBinding => "invalid attestation binding",
